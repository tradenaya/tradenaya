...
const REASON_TEXT: Record<ReasonCode, string> = {
  ...
  [REASON.FLOW_BULLISH]: "volume flow is bullish",
  [REASON.FLOW_BEARISH]: "volume flow is bearish",
  [REASON.FLOW_NEUTRAL]: "volume flow is neutral",
  [REASON.PATTERN_BULLISH]: "bullish candlestick pattern",
  [REASON.PATTERN_BEARISH]: "bearish candlestick pattern",
